<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:38:"./public/static/index/travel\list.html";i:1494505862;s:38:"./public/static/index/public\base.html";i:1494505862;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <table class="table table-striped">
                        ...
                        <tbody>
                        <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $k = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                        <tr>
                            <td><?php echo $k; ?></td>
                            <td><?php echo dateFormat($vo['startTime']); ?></td>
                            <td><?php echo dateFormat($vo['endTime']); ?></td>
                            <td><?php echo $vo['remark']; ?></td>
                            <td><?php echo getTravelState($vo['status']); ?></td>
                        </tr>
