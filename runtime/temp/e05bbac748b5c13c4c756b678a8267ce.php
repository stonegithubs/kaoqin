<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./public/static/admin/index\userlist.html";i:1489546343;s:44:"./public/static/admin/public\admin_base.html";i:1489580593;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<section>
    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="logo">
            <a href="index.html"><img src="<?php echo PUB_PATH; ?>images/logo.png" alt=""></a>
        </div>

        <div class="logo-icon text-center">
            <a href="index.html"><img src="<?php echo PUB_PATH; ?>images/logo_icon.png" alt=""></a>
        </div>
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                <li class="menu-list nav-active"><a href="index.html"><i class="fa fa-home"></i> <span>首页</span></a>
                    <ul class="sub-menu-list">
                        <li class="active"><a href="<?php echo url('Admin/index/index'); ?>"> 仪表盘</a></li>
                    </ul>
                </li>
                ...
                <li class="menu-list"><a href=""><i class="fa fa-map-marker"></i> <span>用户管理</span></a>
                    <ul class="sub-menu-list">
                        <li><a href="<?php echo url('Admin/index/userlist'); ?>">用户列表</a></li>
                    </ul>
                </li>
                <?php endif; ?>
            </ul>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form">
                                        <form class="cmxform form-horizontal adminex-form" id="signupForm" method="post" action="<?php echo url('Admin/index/useradd'); ?>">
...
<script type="text/javascript">
    ...
    function del(obj){
       ...
       $('#confirm_btn').on('click',function(){
           ...
           $.ajax({
               type : "POST",  //提交方式
               url : "<?php echo url('Admin/index/userdel'); ?>",//路径
               data : {
                   "id" : userid
               },//数据，这里使用的是Json格式进行传输
               success : function(result){
                   if(result==1){
                       var div='<div class="alert alert-success fade in">'
                               ...
                               +'</div>';
                       $('#close_btn').click();
                       window.location.href="<?php echo url('Admin/index/userlist'); ?>";
                       $("#alert").after(div);
                   }else if(result==2){
                       $('#close_btn').click();
    ...
    function edit(obj){
        ...
        $.ajax({
            type: "POST",  //提交方式
            url: "<?php echo url('Admin/index/useredit'); ?>",//路径
            data: {
                "id": userid,
                "type":"post",
            },//数据，这里使用的是Json格式进行传输
            success:function(data){
                if(data==2){
                    ...
                    $('#sub_btn').html("修改");
                    $('#signupForm').attr('action',"<?php echo url('Admin/index/useredited'); ?>");
                    $('#addbtn').click();
